...
<link rel="icon" href="../../images/g1.png"/>
<style>
#chat_button
{
	font-size:14px;
	...
	width:80;
	padding:2;
	background-color:#51aeeb; color:white;
...
<body>
	...
	<div style="position:absolute; left:25%; top:13%;"> <img src="../../images/g1.png" height="100" width="100"> </div>
	<div style="position:absolute; left:35%; top:12%;"> <h1 style="color:black;"> Group Chat </h1> </div>
  
    <div style=" background:black; position:absolute; left:25%; top:31.5%; height:21%; width:41.4%; z-index:-1; box-shadow:0px 2px 5px 1px rgb(0,0,0);"> </div>
    <div style=" background:black; position:absolute; left:25%; top:47%; height:8%; width:41.4%; z-index:-1;"> </div>
...
?>
	<td colspan="3"align="right" style="border-top:outset; border-top-width:thick;"> 
			<form method="post">  
				...
				<input type="submit" name="delete_chat" value=" " style="background-color:#FFFFFF; border:#FFFFFF; background:url(img/delete_comment.gif)no-repeat;width:1%;height:1%;"> 
			</form>
     </td>
     <td>  </td>
<?php
...
?>
	...
	<tr>
        ...
        <td colspan="2" style="padding:7;"> <a href="../view_profile/view_profile.php?id=<?php echo $fb_user_id; ?>" style="text-transform:capitalize; text-decoration:none; background:black;color:white;" onMouseOver="chat_name_underLine(<?php echo $chat_id; ?>)" onMouseOut="chat_name_NounderLine(<?php echo $chat_id; ?>)" id="uname<?php echo $chat_id; ?>"> <?php echo $user_name; ?> </a>   </td>
    ...
    <tr>
    	<td> </td>
        <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:black;"> <?php echo $chat_time; ?> </span> </td>
        <td> </td>
    </tr>

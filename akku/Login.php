	...
	if($count1>0)
	{
		...
		if($count2>0)
		{
			...
			if($count3>0)
			{
				...
				if($que2=="" && $ans2=="")
				{
					header("location:step/step3/Secret_Question2.php");
				}
				else
				{
			...
			{
				header("location:step/step2/Secret_Question1.php");
			}
		}
		else
		{
			...
			if($Gender=="Male")
			{
				header("location:step/step1/Step1_Male.php");
			}
			else
			{
				header("location:step/step1/Step1_Female.php");
			}
		}
	}
	else

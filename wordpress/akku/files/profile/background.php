...
<head>
  ...
  <link rel="icon" href="../../images/set7.png"/>
...
<!--Head text-->
<div style="position:fixed;top:0.5%; z-index:2;"> <a href="../home/Home.php" style="text-decoration:none;" onMouseOver="on_head_text()" onMouseOut="out_head_text()"> <img src="../../images/logo1.png" height="50%" width="50%" /></a> </div>
<!--Head logo -->
...
<form name="ut_search" action="../home/Search_Display_submit.php" method="get" onSubmit="return bcheck()">
...
<td><a href="../home/Group_Message.php"title="Group Chat"style="position:fixed; right:9%; top:2.6%; z-index:1;" ><img src="../../images/set3.png" /></a></td>
		<td id="head_home_bg" onMouseOver="head_home_over()" onMouseOut="head_home_out()"> <a title="Home" href="../home/Home.php" id="head_home_font" style="position:fixed;top:2.7%;right:5%; "> <img src="../../images/set2.png"/>  </a> </td>
     </tr>
	</table>
</div>
...
<div style="position:fixed; left:88.2%; top:15%; z-index:3;"><a href="../profile/photos.php" style="text-decoration:none; color:white;" id="head_photos" onMouseOver="head_photos_over()" onMouseOut="head_photos_out()"><h4>Photos</h4></a></div>
	...
	<div style="position:fixed; left:85.8%; top:23%; z-index:3;"> <a href="../home/Settings.php"> <img src="../../images/set4.png" height="25" width="23" onMouseOver="head_settings_over()" onMouseOut="head_settings_out()"> </a> </div>
<div style="position:fixed; left:88.2%; top:20%; z-index:3;"><a href="../home/Settings.php" style="text-decoration:none;color:white;" id="head_settings" onMouseOver="head_settings_over()" onMouseOut="head_settings_out()"><h4> Account Settings </h4></a></div>

<div style="position:fixed; left:86.1%; top:27.5%; z-index:3;"> <a href="../home/feedback.php"> <img src="../../images/set6.png" height="20" width="20" onMouseOver="head_feedback_over()" onMouseOut="head_feedback_out()"> </a> </div>
<div style="position:fixed; left:88.3%; top:24.5%; z-index:3;"><a href="../home/feedback.php" style="text-decoration:none; color:white;" id="head_feedback" onMouseOver="head_feedback_over()" onMouseOut="head_feedback_out()"><h4> Feedback </h4></a></div>
...
<div style="position:fixed; background:black; opacity: 0.8; left:0%; top:0%; height:100%; width:100%; z-index:3" onClick="close_cover_photo()"></div>
<div style="position:fixed; background:black; left:17%; top:5%; height:90%; width:65.5%; z-index:3"></div>
...
<div style="position:fixed; background:black; opacity: 0.8; left:0%; top:0%; height:100%; width:100%; z-index:3"></div>
<div style="position:fixed; background:black; left:30%; top:20%; height:10%; width:35%; z-index:3"></div>
...
<div style="position:fixed; background:black; opacity: 0.8; left:0%; top:0%; height:100%; width:100%; z-index:3" onClick="close_profile_photo()"></div>
<div style="position:fixed; background:black; left:17%; top:5%; height:90%; width:65.5%; z-index:3"></div>
<div style="position:fixed; left:20%; top:10%;z-index:4;">

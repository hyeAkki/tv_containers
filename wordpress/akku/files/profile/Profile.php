...
<div style="position:absolute;left:31.5%; top:54%; font-weight:bold; z-index:1;color:black;">  Timeline  </div>
...
<div style="position:absolute;left:38.3%; top:54%; font-weight:bold; z-index:1;"> <a href="about.php" style="text-decoration:none; color:#00c18e;" onMouseOver="on_about_txt();" onMouseOut="out_about_txt();"> About </a>  </div>
...
<div style="position:absolute;left:44.7%; top:54%; font-weight:bold; z-index:1; color:#00c18e;"> <a href="photos.php" style="text-decoration:none; color:#00c18e;" onMouseOver="on_photos_txt();" onMouseOut="out_photos_txt();">  Photos </a> <samp style="color:#717171;"> <?php echo $photos_count; ?> </samp> </div>

<!--Status-->
<div style=" background:#00c18e; position:absolute; left:37.2%; top:65%; height:22%; width:41.4%; z-index:-1; box-shadow:0px 2px 5px 1px rgb(0,0,0);"> </div>
<div style="position:absolute; left:37.2%; top:62.8%;"> <img src="../../images/step12.png"><input type="button" onClick="upload_close();"  value="Update Status" style="background:#FFFFFF; border:#FFFFFF;"> <img src="../../images/step11.png"><input type="button"  value="Add Photos" onClick="upload_open();" name="file" style="background:#FFFFFF; border:#FFFFFF;"></div>
...
<form method="post" name="posting_txt" onSubmit="return blank_post_check();" id="post_txt">
	...
	<div style="position:absolute; left:37.5%; top:68.5%;">
...
?>
	<tr>
			...
			{?>
				<td colspan="5"align="right" style="border-top:outset; border-top-width:thick;">&nbsp;  </td>
			<td>  </td>
			<td> </td>
			<?php
			}
			...
			{
			?>
			<td colspan="5" align="right" style="border-top:outset; border-top-width:thick;"> 
			<form method="post">  
				<input type="hidden" name="post_id" value="<?php echo $postid; ?>" >
				<input type="submit" name="delete_post" title="Delete" value=" " style="width:32 ;height:32; background:url('../../images/step14.png')"> 
			</form> </td>
			<td>  </td>
			<td> </td>
			<?php } ?>
	...
	<tr>
		<td colspan="3" style="padding:7;"> <a href="#" style="text-transform:capitalize; text-decoration:none; color:#00c18e;" onMouseOver="post_name_underLine(<?php echo $postid; ?>)" onMouseOut="post_name_NounderLine(<?php echo $postid; ?>)" id="uname<?php echo $postid; ?>"> <?php echo $user_name; ?> </a>  </td>
		<td> </td>
		<td> </td>
		<td> </td>
	</tr>
...
<?php 
	...
	<tr style="color:#00c18e;">
		...
		<input type="submit" value="Unlike" name="Unlike" style=" font-size:15px; color:#00c18e;" onMouseOver="unlike_underLine(<?php echo $postid; ?>)" onMouseOut="unlike_NounderLine(<?php echo $postid; ?>)" id="unlike<?php echo $postid; ?>"></form></td>
			<?php
			}
			else
			{?>
		...
		<input type="hidden" name="postid" value="<?php echo $postid; ?>">
		<input type="hidden" name="userid" value="<?php echo $userid; ?>">
		<input type="submit" value="Like" name="Like" style=" font-size:15px; color:#00c18e;" onMouseOver="like_underLine(<?php echo $postid; ?>)" onMouseOut="like_NounderLine(<?php echo $postid; ?>)" id="like<?php echo $postid; ?>"></form></td>
			<?php
			}
		 ?>
		 <?php
	...
	$count_comment=mysql_num_rows($que_comment);
		...
		<td colspan="3"> &nbsp; <input type="button" value="Comment(<?php echo $count_comment; ?>)" style="font-size:15px; color:#00c18e;" onClick="Comment_focus(<?php echo $postid; ?>);" onMouseOver="Comment_underLine(<?php echo $postid; ?>)" onMouseOut="Comment_NounderLine(<?php echo $postid; ?>)" id="comment<?php echo $postid; ?>">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <span style="color:black;">   <?php echo $post_data[4]; ?> </span> </td>
		<td>   </td>
	</tr>
	<tr>
		<td>   </td>
		<td  bgcolor="#EDEFF4" style="width:9;" colspan="3"><img src="../../images/step15.png"><span style="color:#00c18e;"><?php echo $count_like; ?></span> like this. </td>
		<td> </td>
		<td> </td>
	</tr>
	<tr>
...
?>
	...
	<tr>
		...
		<td bgcolor="#EDEFF4" style="padding-left:7;" > <a href="#" style="text-transform:capitalize; text-decoration:none; color:#00c18e;" onMouseOver="Comment_name_underLine(<?php echo $comment_id; ?>)" onMouseOut="Comment_name_NounderLine(<?php echo $comment_id; ?>)" id="cuname<?php echo $comment_id; ?>"> <?php echo $user_name1; ?></a> </td>
...
<!-- About bg-->
	...
	<div style="position:absolute; left:32%; top:66%;"> <img src="../../images/set7.png"> </div>
	</div>
	</a>	
	<div style="position:absolute; left:16%; top:66%;"> <a href="about.php" style="color:black;text-decoration:none;font-size:17px; font-weight:bold;"> About </a> </div>
...
<?php
	...
	{
    ?>
	<div style="position:absolute;left:25%; top:87%; font-size:15px;"> <a href="about.php" style="text-decoration:none; color:#00c18e;"> Add Your City </a> </div>
	<?php
	}
?>
<?php
...
<?php
	...
	{
    ?>
		<div style="position:absolute;left:23%; top:91%; font-size:15px;"> <a href="about.php" style="text-decoration:none;color:#00c18e;"> Add your hometown </a> </div>
	<?php
	}
?>
...
<!-- Photos bg-->
	...
	<div style="position:absolute; left:32%; top:101%;"> <img src="../../images/set5.png"> </div>
	</div>
	</a>	
	<div style="position:absolute; left:16%; top:101%;"> <a href="photos.php" style="color:black;text-decoration:none;font-size:17px; font-weight:bold;"> Photos </a> </div>

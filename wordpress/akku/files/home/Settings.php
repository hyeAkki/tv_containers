...
<body>
	...
	<div style="position:absolute; left:25%; top:18%; color:black; font-size:24px;"> Name: </div>
    <div style="position:absolute; left:32%; top:18%; color:black; font-size:24px; text-transform:capitalize;"> <?php echo $user_name; ?>  </div>
    ...
    <div style="position:absolute; left:25%; top:35%; color:black; font-size:24px;"> Paasword </div>
    <div style="position:absolute; left:34%; top:35%; color:black; font-size:24px;"> ******** </div>
    ...
    <div style="position:absolute; left:25%; top:47%; "> <input type="button" value="Deactivate your account." style="background:black; color:white; font-size:15px; border:none;" onClick="delete_account()"> </div>
...
<div style="position:fixed; background:black; opacity: 0.8; left:0%; top:0%; height:100%; width:100%; z-index:3" onClick="hide_password_change_box()"></div>
<div style="position:fixed; background:black; left:30%; top:20%; height:10%; width:35%; z-index:3"></div>
...
<div style="position:fixed; background:black; opacity: 0.8; left:0%; top:0%; height:100%; width:100%; z-index:3" onClick="hide_delete_account_box()"></div>
<div style="position:fixed; background:black; left:30%; top:20%; height:10%; width:35%; z-index:3"></div>

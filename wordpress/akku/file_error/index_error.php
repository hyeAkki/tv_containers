...
<body>
	...
	<!-- erorr Designing -->
		...
		<div style="position:absolute;left:57.3%; top:90%; height:5%; width:29%; z-index:1; background:white; ">   </div>
			<div style="position:absolute;left:57.2%; top:90%; height:1; width:29.1%; background-color:white; z-index:1; "> </div>
			<div style="position:absolute;left:57.2%; top:90%; height:5.1%; width:0.08%; background-color:white; z-index:1; "> </div>
			<div style="position:absolute;left:57.2%; top:95%; height:1; width:29.1%; background-color:white; z-index:1; "> </div>
			<div style="position:absolute;left:86.3%; top:90%; height:5.1%; width:0.08%; background-color:white; z-index:1; "> </div>
		</div>

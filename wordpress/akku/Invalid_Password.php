...
<link rel="icon" href="images/ver.png" />
	<style>
    body
    {
...
<div style="position:absolute; left:27.4%; top:28.2%;font-size:25px;font-weight: bold;color:white">  Invalid Password   </div>

<div style="position:absolute;left:27.4%; top:32.8%; height:1; width:44.05%; background-color:#CCCCCC; "> </div>

<div style="position:absolute;left:27.4%;top:36.3%; height:10%; width:44.05%; z-index:-1; background:#FFEBE8; ">   </div>

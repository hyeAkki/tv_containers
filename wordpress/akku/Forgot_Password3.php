...
<?php
	...
	if($count1>0)
	{
		...
		echo "<div style='position:absolute; left:30%; top:43%;color:white; font-size:16px'> <h4> Secret Question 2: </h4> </div>";
		echo "<div style='position:absolute; left:40%; top:43%;color:white; font-size:16px'><h4>".$rec1[3]."</h4></div>";
?>
